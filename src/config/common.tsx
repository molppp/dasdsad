...
export const config: AppConfig = {
  ...
  icon: BotIcon,
  inviteUrl:
    'https://discord.com/oauth2/authorize?client_id=1224084614298210397&permissions=0&response_type=code&redirect_uri=https%3A%2F%2Fdasdsad-rouge.vercel.app%2Fapi%2Fauth%2Fcallback&scope=bot+identify+guilds+guilds.join',
  guild: {
